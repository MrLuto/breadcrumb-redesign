                ...
                <div className="flex-1 min-w-0">
                  ...
                  {optionsText && (
                    <button
                      ...
                      className="flex items-center gap-1 text-xs text-muted-foreground hover:text-primary transition-colors max-w-full"
                    >
                      <span className="truncate max-w-[120px] sm:max-w-[160px]">{optionsText}</span>
                      <Pencil className="h-3 w-3 shrink-0" />
                    </button>
                  )}
                  {!hasOptions && item.product.category_id && (
                    <button
                      type="button"
                      onClick={() => setEditingItem(item)}
